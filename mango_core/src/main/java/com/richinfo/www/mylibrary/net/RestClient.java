...
import com.richinfo.www.mylibrary.net.callback.IRequest;
import com.richinfo.www.mylibrary.net.callback.ISuccess;
import com.richinfo.www.mylibrary.net.callback.RequestCallbacks;
...
public final class RestClient {
    ...
    private void request(HttpMethod method) {
        ...
        if (LOADER_STYLE != null) {
            MangoLoader.showLoading(CONTEXT, LOADER_STYLE);
        }
        switch (method) {
            case GET:
